...
export const msg = {
  ...
  comoVerificar: (endereco, minutos, jaTem) => {
    ...
    return [
       ...
       */
      '**Send 0 RON.** Any amount works, but this address has no owner — nobody can ever spend from it, not us and not you. Anything you send is destroyed. It is not a donation.',
      '',
      `You have **${minutos} minutes**. Only gas is spent.`,
      '',
