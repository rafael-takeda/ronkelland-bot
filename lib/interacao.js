...
export async function decide(corpo, { segredo }) {
  ...
  if (ehVerify) {
    ...
    /*
     * UMA MENSAGEM SÓ, e não por preguiça.
     *
     * Tentei mandar o endereço numa segunda mensagem, pra ele ficar sozinho e
     * ganhar o botão de copiar do Discord móvel. Não funciona neste host:
     * mensagem de acompanhamento exige interação já respondida, e a Vercel corta
     * a rede da função assim que a resposta sai (medido: ECONNRESET contra
     * discord.com, e numa das tentativas nem o log de erro chegou a sair).
     *
     * Por isso o endereço subiu pro topo desta mensagem — ver `comoVerificar`.
     */
    return {
